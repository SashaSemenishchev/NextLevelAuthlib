...
public class YggdrasilAuthenticationService extends HttpAuthenticationService {
    ...
    private static Environment determineEnvironment() {
        return
                EnvironmentParser.getEnvironmentFromProperties()
    ...
    public UserAuthentication createUserAuthentication(Agent agent) {
        ...
        return (UserAuthentication)new YggdrasilUserAuthentication(this, this.clientToken, agent, this.environment);
    }
    ...
    protected <T extends Response> T makeRequest(URL url, Object input, Class<T> classOfT) throws AuthenticationException {
        return makeRequest(url, input, classOfT, (String)null);
    }
